...
10 اختبارات خضراء تغطي: عقد التصنيفات، السكيما المرجعية، عقد المساعد (intents + dates)، جدولة التذكيرات، وnormalization الدارجة للبحث. اختبار `auth.logout` متعمد `skip` حتى يكتمل ربط المصادقة.
